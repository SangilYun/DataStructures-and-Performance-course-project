...
public class EarthquakeCityMap extends PApplet {
	...
	private String cityFile = "/Users/yunsangil/Documents/computing/JAVA/UCSDUnfoldingMaps/data/city-data.json";
	private String countryFile = "/Users/yunsangil/Documents/computing/JAVA/UCSDUnfoldingMaps/data/countries.geo.json";
...
//			System.out.println("landQuakeMarker properties : " + qm.getProperty("country"));
//			}
//			else if(qm instanceof OceanQuakeMarker) {
//				System.out.println("OceanQuakeMarker properties : " + qm.getProperties());
//			}
//			else {
//				System.out.println("earthQuakeMarker properties : " + qm.getProperties());
//			}
//		}
//		for(Marker cm : countryMarkers) {
//			System.out.println("countryMarkers : " + cm.getProperty("name"));
//		}
		for(Marker cm : countryMarkers) {
			int countryCount=0;
			...
			for(Marker qm : quakeMarkers) {
				if(qm instanceof LandQuakeMarker) {
					String quakeName = (String)qm.getProperty("country");
					if(quakeName.equals(countryName)) {
						countryCount++;
					}
				}
			}
		...
		System.out.println("OceanCount : " + oceanCount);
	}
